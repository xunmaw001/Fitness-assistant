<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信平台健身小助手小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='jianshenfang'" class="input-group">
			   <div class="label">健身房名称</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jianshenfangmingcheng" class="input" type="text" placeholder="健身房名称">
			   </div>
			 </div> -->
			<el-form-item label="健身房名称" class="input" v-if="tableName=='jianshenfang'">
			  <el-input v-model="ruleForm.jianshenfangmingcheng" autocomplete="off" placeholder="健身房名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jianshenfang'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jianshenfang'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='jianshenfang'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='jianshenfang'" class="input-group">
			   <div class="label">健身房地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jianshenfangdizhi" class="input" type="text" placeholder="健身房地址">
			   </div>
			 </div> -->
			<el-form-item label="健身房地址" class="input" v-if="tableName=='jianshenfang'">
			  <el-input v-model="ruleForm.jianshenfangdizhi" autocomplete="off" placeholder="健身房地址"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jianshenfang'" class="input-group">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='jianshenfang'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='jianshenfang'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jianshenfang'" class="input-group">
			   <div class="label">营业时间</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yingyeshijian" class="input" type="text" placeholder="营业时间">
			   </div>
			 </div> -->
			<el-form-item label="营业时间" class="input" v-if="tableName=='jianshenfang'">
			  <el-input v-model="ruleForm.yingyeshijian" autocomplete="off" placeholder="营业时间"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `jianshenfang` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220121/609a8263a03241cfa436948544be75ae.png);
