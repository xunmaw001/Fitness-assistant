<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="健身项目" prop="jianshenxiangmu">
          <el-select :disabled="ro.jianshenxiangmu" v-model="ruleForm.jianshenxiangmu" placeholder="请选择健身项目">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="健身项目" prop="jianshenxiangmu">
	      <el-input v-model="ruleForm.jianshenxiangmu"
                placeholder="健身项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xiangmufengmian" label="项目封面" prop="xiangmufengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.xiangmufengmian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="健身类型" prop="jianshenleixing">
          <el-input v-model="ruleForm.jianshenleixing" 
              placeholder="健身类型" clearable  :readonly="ro.jianshenleixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课时数" prop="keshishu">
          <el-input v-model="ruleForm.keshishu" 
              placeholder="课时数" clearable  :readonly="ro.keshishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课时数" prop="keshishu">
              <el-input v-model="ruleForm.keshishu" 
                placeholder="课时数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="健身房名称" prop="jianshenfangmingcheng">
          <el-input v-model="ruleForm.jianshenfangmingcheng" 
              placeholder="健身房名称" clearable  :readonly="ro.jianshenfangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="健身房名称" prop="jianshenfangmingcheng">
              <el-input v-model="ruleForm.jianshenfangmingcheng" 
                placeholder="健身房名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="健身房地址" prop="jianshenfangdizhi">
          <el-input v-model="ruleForm.jianshenfangdizhi" 
              placeholder="健身房地址" clearable  :readonly="ro.jianshenfangdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="健身房地址" prop="jianshenfangdizhi">
              <el-input v-model="ruleForm.jianshenfangdizhi" 
                placeholder="健身房地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	xiangqing : false,
      ...
      rules: {
          ...
          jianshenxiangmu: [
                { required: true, message: '健身项目不能为空', trigger: 'blur' },
          ],
          xiangmufengmian: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmujiage = true;
          ...
          if(o=='keshishu'){
            this.ruleForm.keshishu = obj[o];
	    this.ro.keshishu = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jianshenfangmingcheng!=''&&json.jianshenfangmingcheng){
                this.ruleForm.jianshenfangmingcheng = json.jianshenfangmingcheng
	    		this.ro.jianshenfangmingcheng = true;
		}
		if(json.jianshenfangdizhi!=''&&json.jianshenfangdizhi){
                this.ruleForm.jianshenfangdizhi = json.jianshenfangdizhi
	    		this.ro.jianshenfangdizhi = true;
		}
        } else {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm2hqxt/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jianshenxiangmu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jianshenxiangmuCrossAddOrUpdateFlag = false;
						 this.parent.search();
