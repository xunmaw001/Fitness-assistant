<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="项目编号" prop="xiangmubianhao">
          <el-input v-model="ruleForm.xiangmubianhao" 
              placeholder="项目编号" clearable  :readonly="ro.xiangmubianhao"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="健身项目" prop="jianshenxiangmu">
          <el-input v-model="ruleForm.jianshenxiangmu" 
              placeholder="健身项目" clearable  :readonly="ro.jianshenxiangmu"></el-input>
        </el-form-item>
        <div v-else>
