<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="健身时长" prop="jianshenshizhang">
          <el-input v-model="ruleForm.jianshenshizhang" 
              placeholder="健身时长" clearable  :readonly="ro.jianshenshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="健身时长" prop="jianshenshizhang">
              <el-input v-model="ruleForm.jianshenshizhang" 
                placeholder="健身时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jianshendaka/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jianshendakaCrossAddOrUpdateFlag = false;
						 this.parent.search();
