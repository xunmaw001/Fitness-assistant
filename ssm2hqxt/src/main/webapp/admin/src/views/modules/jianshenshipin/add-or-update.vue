<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.jiaoxueshipin" label="教学视频" prop="jiaoxueshipin">
          <file-upload
          tip="点击上传教学视频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiaoxueshipin" label="教学视频" prop="jiaoxueshipin">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.jiaoxueshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="基本介绍" prop="jibenjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jibenjieshao" label="基本介绍" prop="jibenjieshao">
                    <span v-html="ruleForm.jibenjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.jibenjieshao = this.ruleForm.jibenjieshao.replace(reg,'../../../ssm2hqxt/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
