...
public class JianshenxiangmuController {
    ...
    public R page(@RequestParam Map<String, Object> params,JianshenxiangmuEntity jianshenxiangmu, 
		...
		if(tableName.equals("jianshenfang")) {
			jianshenxiangmu.setJianshenfangmingcheng((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("jianshenfang")) {
			wrapper.eq("jianshenfangmingcheng", (String)request.getSession().getAttribute("username"));
		}
